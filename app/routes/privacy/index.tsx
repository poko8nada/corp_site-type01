...
const PRIVACY_LINES = [
  '当店は、お問い合わせフォームを通じてお客様の氏名、メールアドレス、電話番号等の個人情報をご提供いただく場合がございます。',
  'お客様からお預かりした個人情報は、お問い合わせへの回答・ご予約の確認・ご連絡のみに利用し、それ以外の目的で利用することはございません。',
  '当店は、法令に基づく場合を除き、お客様の同意なく個人情報を第三者に開示・提供することはいたしません。',
